...
The text file path is `~/code/<user.github_nickname>/{{local_path_to("02-Data-Toolkit/02-Data-Sourcing/03-Text-Extraction-with-Regex")}}/data/receipts.txt`. <br> You can download it [here](https://gist.githubusercontent.com/ssaunier/5da499eb08817d8b7f56d397870df33d/raw/receipts.txt) (save: `cmd + s` on mac, `ctrl + s` on windows)
